    ...
    <div className="container mx-auto px-6 py-6 relative z-10">
      <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-120px)]">
        ...
        <div className="flex justify-center items-center">
          <img
            src="/QualityImage.jpg" // Place your image in public as 'family.jpg' or update the path accordingly
        ...
        <div className="text-left text-gray-900 space-y-8 lg:pl-8">
          ...
          <p className="text-2xl text-gray-700 leading-relaxed max-w-lg">
            We know time is of the essence and with Healthify you can see a doctor within 20 minutes. your notes, prescription and test requests are available after the consultation... and you can ask questions after the consultation for free!
          </p>
        </div>
      </div>
    </div>
